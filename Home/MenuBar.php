...
<link rel="stylesheet" href="../css/bootstrap.css">
  ...
  if($_SERVER['PHP_SELF'] == '/index.php' ){
    $home = '<div class = "container bg-light">Home</div>';
  }
  elseif($_SERVER['PHP_SELF'] == '/counselingSession/main.php' or $_SERVER['PHP_SELF'] == '/counselingSession/combinations.php' ){
    $cs = '<div style = "border-radius: 0px 8px 0px 8px;" class = "container bg-light">Counselling Session</div>';
  }
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top  bg-white  id="mainNav">
    <div class="container">
      ...
      <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link " href="../iqTest/IQ_test1.php"><?php echo $ge;?></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link " href="index.php"><?php  $_SESSION['logon'] = 'off'; echo 'Sign Out';?> </a>
          </li>
  ...
  <!-- activating the boostrap js file messes up all he submit buttons and diactivating messes up the dropdown menu functionality for mobile devices do not add ../ -->
