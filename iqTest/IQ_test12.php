...
<div class="card border-success mb-3" style="max-width: 45rem;">
  ...
  <div class="card-body text-success">
               ...
               <fieldset class="btn-group-vertical" >
                  <form method = "get" action = "IQ_test12.php" >
                    <img class = "img-fluid" src = "pics/question12.png"/ alt = "image could not be loaded"> <br />
                What number should replace the question mark? <br />

                <input type="radio" name="question12" value="answer1" checked="checked" /> <b>11</b> <br />
                <input type="radio" name="question12" value="answer2"  /> <b>10</b> <br />
                <input type="radio" name="question12" value="answer3"  /> <b>9</b> <br />
                <input type="radio" name="question12" value="answer4"  /> <b>7</b> <br /> <br />
                <input type = "submit" value = "submit" class="btn btn-outline-success btn-sm btn-block>
                  
                  </form>
                  <?php
                  $question12 = "answer3";
                  if(isset($_GET['question12']) != null && $_SESSION['p12Visited'] != 1){
                   if($_GET['question12'] == "answer3"){
                      $_SESSION['mark'] = $_SESSION['mark'] + 1;
                    }
                    $_SESSION['p12Visited'] = TRUE;
...
?>
<hr />
<a href="IQ_test13.php"><button type="button" class="btn btn-outline-secondary">Next Question</button></a>
<!-- fifth change -->
</div>
</div>
                  </div>
