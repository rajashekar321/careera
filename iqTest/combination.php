...
echo'<h2>Select an A level Combination in your preffered Branch of Science</h2> <br /> <br />';
  ...
  if(!isset($_POST['subject'][0]) or !isset($_POST['subject'][1]) or !isset($_POST['subject'][2])){
    die('<br /> <br /><div class = "card container  bg-light">
    <br /> <br /> <h1 class = "text-danger">Error!!<br />Please enter a valid combination of 3 subjects</h1>
    <br /> 
    <a href ="subjectSelection.php"><button type="button"   class="btn btn-outline-dark">&nbsp &nbsp Back &nbsp &nbsp</button></a>
    <br /><br />
    </div><br /> <br />');
   ...
   if( $results = $con->query($query) ){
    ...
    if($results->num_rows > 0){  
                while($row = $results->fetch_assoc()){
                      ...
                      <div class="card-body">
                        <h4 class="card-title">Branch: <label class="text-success">'.$row['keyword'].'</label></h4>
                      ...
                      <div class="form-check form-check-inline">
                        ...
                        <button type="submit" class="btn btn-warning" name="mathP">Tertiary Level Options</button>
                        </form>
        ...
        echo '<br /> <br /><div class = "card container  bg-light">
        <br /> <br /> <h1 class = "text-danger">Error!!<br />Could not run Query<br />Please try other options</h1>
        <br /> 
        <a href ="subjectSelection.php"><button type="button"   class="btn btn-outline-dark">&nbsp &nbsp Back &nbsp &nbsp</button></a>
        <br /><br />
        </div><br /> <br />';
