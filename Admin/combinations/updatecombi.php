    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Update Combination</h1>
      ...
      <div class = "card  jumbotron  col-md-11 col-md-offset-1 col-md-pull-1" >
            ...
            <div class="form-group ">
                    ...
                    <div class="form-group ">
											<input type="text"name = "subject1" class="form-control" placeholder="subject 1" maxlength = "19" required = "required">
                    </div>
                    <div class="form-group ">
											<input type="text"name = "subject2" class="form-control" placeholder="subject 2" maxlength = "19" required = "required">
                    </div>
                    <div class="form-group ">
											<input type="text"name = "subject3" class="form-control" placeholder="subject 3" maxlength = "19" required = "required">
										</div>
