      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="form-group ">
                ...
                <div class="form-group">
                  <textarea name="requirements" required = "required" maxlength = "695" id="message" cols="30" rows="5" class="form-control" placeholder="Requirements"></textarea>
                                    </div>
             
                <div class="form-group ">
                  <select name="institute"  class = "col-md-12 form-control" >
                ...
                <div class="form-group ">
                  <select name="career_group"  class = "col-md-12 form-control" >
                  <option disabled selected >Career Group</option>
                ...
                <div class="form-group ">
                <select name="keyword"  class = "col-md-12 form-control" >
                ...
                <div class="form-group ">
                  <input type="number"name = "miniq" class="form-control" placeholder="Minimum IQ Requirement" maxlength = "19" required = "required">
                </div>
                <div class="form-group ">
                  <input type="number"name = "maxiq" class="form-control" placeholder="Maximum IQ Requirement" maxlength = "19" required = "required">
                </div>
