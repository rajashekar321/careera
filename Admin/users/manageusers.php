          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <form action="updateprocess.php" method = "post">
                    ...
                    <div class="form-group ">
											<input type="text" name = "username" class="form-control" placeholder="Enter The User's Username" maxlength = "19" required = "required">
                    </div>
                    ...
                    <option disabled selected >Set User Priveledges</option>
