        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <form action="addprocess.php" method = "post">
                    ...
                    <div class="form-group ">
											<input type="text"name = "surname" class="form-control" placeholder="surname" maxlength = "19" required = "required">
                    </div>

                     <div class="form-group ">
											<input type="text"name = "username" class="form-control" placeholder="username" maxlength = "19" required = "required">
                    </div>
                    ...
                    <div class="form-group ">
											<input type="email" name = "email" class="form-control" placeholder="name@example.com" maxlength = "19" required = "required">
                                        </div>
                    
                                        <div class="form-group ">
                    <select name="userType"  class = "col-md-12 form-control" >
